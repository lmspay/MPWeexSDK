...
/**
 *  @abstract convert date string with specified format to date.
 *
 */
+ (NSDate *_Nullable)dateStringToDate:(NSString *_Nullable)dateString format:(NSString *_Nullable)formatString;

/**
 *  @abstract convert time string with specified format to date.
 *
 */
+ (NSDate *_Nullable)timeStringToDate:(NSString *_Nullable)timeString format:(NSString *_Nullable)formatString;

/**
 *  @abstract convert date to date string with specified format.
 *
 */
+ (NSString *_Nullable)dateToString:(NSDate *_Nullable)date format:(NSString *_Nullable)formatString;

/**
 *  @abstract convert date to time string with specified format.
 *
 */
+ (NSString *_Nullable)timeToString:(NSDate *_Nullable)date format:(NSString *_Nullable)formatString;
